...
module Organizations
  class ReportsControllerTest < ActionController::TestCase
    ...
    test "should be able to select a week time_frame" do
      get :index, params: { filter: { time_frame: Organizations::Reports::Filter::WEEK } }
    ...
    test "should be able to select a client" do
      ...
      assert_equal client.name, assigns(:filter).selected_elements_names[Organizations::Reports::Filter::CLIENTS].first
    ...
    test "should be able to select a project" do
      ...
      assert_equal project.name, assigns(:filter).selected_elements_names[Organizations::Reports::Filter::PROJECTS].first
    ...
    test "should be able to select a task" do
      ...
      assert_equal task.name, assigns(:filter).selected_elements_names[Organizations::Reports::Filter::TASKS].first
    ...
    test "should be able to select a user" do
      ...
      assert_equal user.name, assigns(:filter).selected_elements_names[Organizations::Reports::Filter::USERS].first
