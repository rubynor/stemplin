  ...
  class DialogContent < Base
    ...
    def backdrop
      div(
        ...
        class:
              "fixed pointer-events-auto inset-0 z-50 bg-zinc-900/40 backdrop-blur-[2px] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0"
      )
    end
  end
end
